class MoviesController < ApplicationController
  ...
  before_action :check_for_login, :only => [:search_tmdb,  :new, :edit, :destroy]
  ...
  def add
    if Movie.exists?(:title => params.title,:description => params.overview) == false
      permitted = {:title => params.title,:release_date =>params.release_date,:description => params.overview}
